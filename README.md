...
- Dashboard only surfaces active (reachable) hosts to avoid subnet noise
- Delete hosts or click through to a dedicated host detail page showing per-device metrics
